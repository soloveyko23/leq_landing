(() => {
    ...
    (() => {
        ...
        da.init();
        const headerLangBtn = document.querySelector("#headerLang .header__lang-btn");
        const headerLangList = document.querySelector("#headerLang .header__lang-list");
        const toggleMenu = function() {
            headerLangList.classList.toggle("open");
            headerLangBtn.classList.toggle("_active");
        };
        headerLangBtn.addEventListener("click", (function(e) {
            e.stopPropagation();
            toggleMenu();
        }));
        document.addEventListener("click", (function(e) {
            const target = e.target;
            const its_menu = target == headerLangList || headerLangList.contains(target);
            const its_btnMenu = target == headerLangBtn;
            const menu_is_active = headerLangList.classList.contains("open");
